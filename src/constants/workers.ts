...
const workers: workersData[] = [
    {
        name: "Slave",
        description:
            "Multipurpose worker and someone's property. May be granted citizenship one day",
        costGold: 1,
        costGrain: 15,
        costStone: 0,
        goldPerClick: 1,
    ...
    },
    {
        name: "Farmer",
        description:
            "People dedicated to the craft of the land. Actually mostly slaves. ",
        costGold: 5,
        costGrain: 50,
        costStone: 0,
        goldPerClick: 0,
    ...
    },
    {
        name: "Miner",
        description:
            "Workers for the mines. Ill-fated people, likely to face death. Good for the economy, though.",
        costGold: 5,
        costGrain: 50,
        costStone: 0,
        goldPerClick: 1,
    ...
    },
    {
        name: "Legionary",
        description:
            "Soldiers, security and even builders. Legionaries are really versatile.",
        costGold: 10000,
        costGrain: 5000,
        costStone: 0,
        goldPerClick: 100,
